  ...
  return (
    <Container>
      <div className="product-detail-container">
        <div class="product_image" data-flickity-options='{ "wrapAround": true }'>
          {product.p_img && (
          ...
          <div className="carousel-controls">
            <Button className="carousel-control-prev-icon" variant="light" onClick={handlePrev}>
            </Button>
            <Button className="carousel-control-next-icon" variant="light" onClick={handleNext}>
            </Button>
          </div>
        </div>
