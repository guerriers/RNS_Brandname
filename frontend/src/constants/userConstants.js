...
export const CHECK_VERIFY_REQUEST = 'CHECK_VERIFY_REQUEST'
export const CHECK_VERIFY_SUCCESS = 'CHECK_VERIFY_SUCCESS'
export const CHECK_VERIFY_FAIL = 'CHECK_VERIFY_FAIL'
...
export const SEND_REVIEW_INVITATION_REQUEST = 'SEND_REVIEW_INVITATION_REQUEST';
export const SEND_REVIEW_INVITATION_SUCCESS = 'SEND_REVIEW_INVITATION_SUCCESS';
export const SEND_REVIEW_INVITATION_FAIL = 'SEND_REVIEW_INVITATION_FAIL';
